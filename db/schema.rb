...
ActiveRecord::Schema.define(version: 20161118202543) do
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["source_application_id"], name: "index_questions_on_source_application_id", using: :btree
  end
  ...
  create_table "source_applications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["source_id"], name: "index_source_applications_on_source_id", using: :btree
    t.index ["year"], name: "index_source_applications_on_year", using: :btree
  end
